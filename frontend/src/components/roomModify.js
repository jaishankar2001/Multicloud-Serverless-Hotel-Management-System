    ...
    <div id="AddRoom" className="text-center" style={{ textAlign: 'center' }}>
      <div className="container" style={{ margin: 'auto', maxWidth: '600px' }}>
        <div className="section-title" style={{ marginBottom: '10px' }}>
          <h2 style={{ marginBottom: '20px' }}>Add Room Quantity</h2>
          <p style={{ marginBottom: '20px' }}>Welcome to the admin page. Please fill out the form below to add room quantities.</p>
          <img
